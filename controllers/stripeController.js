...
exports.createCheckoutSession = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      locale: "en", // Use 'en' as 'en-US' is not supported by Stripe Checkout
      line_items: [
        {
          price_data: {
            currency: "bdt",
...
exports.handleWebhook = async (req, res) => {
  ...
  // console.log("Headers:", req.headers); // Too verbose to log all headers
  ...
  if (event.type === "checkout.session.completed") {
    ...
    try {
      ...
      console.log(`  ⭐️ isPremium: ${updatedUser.isPremium}`);
